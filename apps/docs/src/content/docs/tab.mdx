...
All focusable elements in tabs are included in the page <kbd>Tab</kbd> sequence.

Tabs have keyboard support including <kbd>Tab</kbd>, <kbd>Left Arrow</kbd>, <kbd>Right Arrow</kbd>, <kbd>Home</kbd>, and <kbd>End</kbd>.

When focused, tab buttons expand the panel with <kbd>Space</kbd> or <kbd>Enter</kbd> keys.
