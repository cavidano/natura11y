...
Pressing <kbd>Escape</kbd> closes an open dropdown and returns focus to the trigger.
...
<TableLineDescRow targetFigure="1" lines="5-15">
...
<TableLineDescRow targetFigure="1" lines="32-43">
    ...
    code={`
        <ul class="nav nav--horizontal">
            ...
            <li>
                ...
                <ul class="dropdown__menu" id="docs-dropdown">
                    <li>
                        <a href="#1">Link</a>
                    </li>
                    <li>
...
<TableLineDescRow targetFigure="4" lines="10-15">
...
<TableLineDescRow targetFigure="5" lines="18">
...
<TableLineDescRow targetFigure="5" lines="5-16">
