...
import BorderColor from '../../components/examples/border/BorderColor.astro';
import BorderDirectional from '../../components/examples/border/BorderDirectional.astro';
import BorderRadius from '../../components/examples/border/BorderRadius.astro';
...
<FigureExample
  ...
  `}
>
  <BorderColor borderType="direction" />
</FigureExample>
