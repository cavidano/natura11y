...
Use <LinkOpenNew LinkUrl="https://developer.mozilla.org/en-US/docs/Web/CSS/border" LinkText="border" /> and <LinkOpenNew LinkUrl="https://developer.mozilla.org/en-US/docs/Web/CSS/border-radius" LinkText="border radius" /> utilities to add outlines, side borders, rounded corners, and theme-aware border colors.
...
Add a border radius to any element with Natura11y's border radius utilities. Use the numbered radius scale, pill and circle radius utilities, or directional radius utilities. Include a <a href="/docs/breakpoint/#breakpoint-modifiers">breakpoint modifier</a> to apply a border radius at a specific breakpoint (Figure 4).
...
<RelatedCustomProperties
  ...
  properties={[
    ...
    },
    {
      ...
      purpose: 'Color used by border utilities unless a theme or border color utility overrides it.',
    },
    {
