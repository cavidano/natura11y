...
Natura11y provides an assortment of style options for <LinkOpenNew LinkUrl='https://developer.mozilla.org/en-US/docs/Web/HTML/Element/table' LinkText='data tables' />. Including two different approaches for presenting tables on smaller viewports.
...
All that is needed for a basic table is the <code>.table</code> selector present on the <code>&lt;table&gt;</code> tag.
