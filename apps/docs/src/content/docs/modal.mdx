...
description: 
    Create accessible modal dialogs with keyboard navigation, focus management, ARIA roles, optional backdrop clicks, and escape key handling.
relatedPages:
  - "Lightbox"
  - "Accessibility"
---
...
<FigureExample
    figureNumber="1"
    highlightedLines="3-10,14-18,19-24,25-32,34-36,38-47"
    code={`
    <!-- Modal button -->
...
<TableLineDescRow targetFigure="1" lines="19-24">
...
<TableLineDescRow targetFigure="1" lines="25-32">
...
<TableLineDescRow targetFigure="1" lines="34-36">
...
<TableLineDescRow targetFigure="1" lines="38-47">
