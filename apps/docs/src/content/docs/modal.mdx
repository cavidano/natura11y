...
Modals have keyboard support for focusable elements. Use the *Tab* and *Shift + Tab* keys without leaving the modal by accident. Using the *Esc* key closes the modal.
