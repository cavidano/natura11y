...
description: Create expandable content sections with show/hide functionality. Includes button triggers, target selectors, and accessibility patterns.
relatedPages:
  - Button
  - Navigation
---
...
Pressing <kbd>Escape</kbd> while focus is inside the collapsed panel closes it and returns focus to the trigger button.
...
<FigureExample
  figureNumber="1"
  highlightedLines="3-6,12-13,14-30"
  code={`
  <button
...
<TableLineDescRow targetFigure="1" lines="12-13">
...
<TableLineDescRow targetFigure="1" lines="14-30">
