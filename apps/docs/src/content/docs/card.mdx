...
description: Build content cards with optional headers, media, body content, and footers.
relatedPages:
  - Color
  - Button
  - Typography
...
The Natura11y card component organizes related content into flexible sections.
...
Here is an example of a basic card.
...
Use `.card__body` for the card's main content. Cards can have multiple `.card__body` elements.
