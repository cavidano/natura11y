...
Intuitively mark *required* fields with `data-required="true"`. Natura11y's JavaScript adds the `required` attribute to the field automatically.
...
<FigureExample
	figureNumber="2"
	highlightedLines="1,10,17-24,26-28"
	code={`
...
<TableLineDescRow targetFigure="2" lines="17-24">
...
<TableLineDescRow targetFigure="2" lines="26-28">
...
The label is associated implicitly because the `<label>` element wraps the `<select>` element.
...
The `<select>` tag's `id` can be used by help text, validation, and custom scripting.
...
<FigureExample
	figureNumber="5"
	highlightedLines="11,13,16,18-21"
	code={`
	<div class="form-entry">
...
<TableLineDescRow targetFigure="6" lines="10">
...
<TableLineDescRow targetFigure="6" lines="17-19">
...
<TableLineDescRow targetFigure="9" lines="10">
...
<TableLineDescRow targetFigure="9" lines="17-19">
...
The two data attributes mentioned above are shown in Figure 10, lines 3 and 4. When `data-required="true"` is present on the `.form-entry` selector, Natura11y's JavaScript adds the `required` attribute to the form entry's child field automatically.
...
<FigureExample
	figureNumber="11"
	markedText={['data-validate', 'novalidate']}
	code={`
...
<FigureExample
	figureNumber="12"
	markedText="form-entry__field--float"
	code={`
		<div
				class="form-entry"
				data-required="true"
